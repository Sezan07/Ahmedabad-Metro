...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaClock, FaInfoCircle } from 'react-icons/fa';
  ...
  <div className="contact-container">
    ...
    <div className="contact-grid">
      <div className="contact-section">
        <h2><FaMapMarkerAlt className="section-icon" /> Corporate Office</h2>
      ...
      <div className="contact-section">
        <h2><FaPhone className="section-icon" /> Contact Information</h2>
        <div className="contact-card">
      ...
      <div className="contact-section">
        <h2><FaInfoCircle className="section-icon" /> Lost & Found</h2>
        <div className="contact-card">
          <div className="contact-info">
            <FaMapMarkerAlt className="icon" />
